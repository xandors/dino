...
setup(
    ...
    description='Dino Dependency Injection for Python',
    long_description=parse_readme(),
    # What does your project relate to? Separate with spaces.
    keywords='dino development',
    author='Alexandre Souza',
    author_email='xandors@gmail.com',
    license='MIT',

    # The project's main homepage
    url='https://github.com/xandors/dino',
