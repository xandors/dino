...
# Copyright 2016 Alexandre Ribeiro de Souza <xandors@gmail.com>.
#
...
class Joinpoint(object):
    ...
    def __init__(self, target=None, args=None, kwargs=None, advices=None, ctx=None, exec_ctx=None):
        ...
        :param Iterable advices: iterable of advices which take in parameters this joinpoint.
            If None, they will be dynamically loaded during self proceeding time related to target.
    ...
    def start(self, target=None, args=None, kwargs=None, advices=None, exec_ctx=None, ctx=None):
        ...
        :param list advices: advices to use in proceeding. self advices by default.
        :param dict exec_ctx: execution context.
        :param target ctx: target ctx to use in proceeding.
        :return: self.proceed()
        """
    ...
    def apply_pointcut(self, target, function=None, ctx=None):
        ...
        # flag which indicates that the function is not a pure python function and has to be wrapped
