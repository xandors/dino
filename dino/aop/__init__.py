...
class MethodInvocation(object):
    ...
    def __init__(self, instance, method_name, args, kwargs, interceptors):
        ...
        self.logger = logging.getLogger("dino.aop.MethodInvocation")
    ...
    def proceed(self):
        ...
        self.logger.debug(
            "Calling %s.%s(%s, %s)" % (interceptor.__class__.__name__, self.method_name, self.args, self.kwargs))
    ...
    def __getattr__(self, name):
        ...
        block of code."""
        self.iterator = self.get_interceptor()
