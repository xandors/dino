...
## Issue tracker
dino uses the excellent [GitHub issue tracker][issues].

Personally, I also recommend giving [ZenHub][zenhub] a try. After installing the Google Chrome plugin, visit the [dino boards][repo-boards]. This way, it's very easy to get an overview of the current bug/feature request situation.
...
### Report Bugs
Report bugs at [xandors/dino/issues][issues].
...
### Write Documentation
Dino Dependency Injection could always use more documentation, whether as part of the official Dino Dependency Injection docs, in inline docstrings, or even on the web in blog posts, articles, and such.
...
## Get Started!
Ready to contribute? Here's how to set up `Dino Dependency Injection` for local development.

> Over time my ambition is to provide a reproducable and automated setup through Vagrant.

1. Fork the [xandors/dino][repo] repo on GitHub

2. Clone your fork locally:

  ```bash
  $ git clone git@github.com:<your github username>/dino.git
  ```
...
## Coding conventions
Generally I recommend two ways to stay up-to-date on dino coding standards.
...
[issues]: https://github.com/xandors/dino/issues
[repo]: https://github.com/xandors/dino
[repo-boards]: https://github.com/xandors/dino/issues#boards
[sourcetree]: http://www.sourcetreeapp.com/
[travis]: https://travis-ci.org/xandors/dino/pull_requests
